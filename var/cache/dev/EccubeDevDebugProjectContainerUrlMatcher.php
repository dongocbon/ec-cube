    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/dashboard')) {
            ...
            if (0 === strpos($pathinfo, '/dashboard/s')) {
                ...
                // customize_samplepage_testmethod3
                if ('/dashboard/sample1' === $pathinfo) {
                    $ret = array (  '_controller' => 'Customize\\Controller\\SamplePageController::testMethod3',  '_route' => 'customize_samplepage_testmethod3',);
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    ...
                    if (!in_array($canonicalMethod, ['GET'])) {
                        ...
                        goto not_customize_samplepage_testmethod3;
                    }
                    if (!$hasRequiredScheme) {
                        if ('GET' !== $canonicalMethod) {
                            goto not_customize_samplepage_testmethod3;
                        ...
                        return array_replace($ret, $this->redirect($rawPathinfo, 'customize_samplepage_testmethod3', key($requiredSchemes)));
                    }

                    return $ret;
                }
                not_customize_samplepage_testmethod3:
        ...
        elseif (0 === strpos($pathinfo, '/sample')) {
            // sample
            if ('/sample' === $pathinfo) {
                $ret = array (  '_controller' => 'Customize\\Controller\\SamplePageController::testMethod1',  '_route' => 'sample',);
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                if (!in_array($canonicalMethod, ['GET'])) {
                    if ($hasRequiredScheme) {
                ...
                if (!$hasRequiredScheme) {
                    ...
                    return array_replace($ret, $this->redirect($rawPathinfo, 'sample', key($requiredSchemes)));
                }
            ...
            if (preg_match('#^/sample/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'sample_page']), array (  '_controller' => 'Customize\\Controller\\SamplePageController::testMethod',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                if (!in_array($canonicalMethod, ['GET'])) {
                    if ($hasRequiredScheme) {
        ...
        if ('/redirect' === $pathinfo) {
            $ret = array (  '_controller' => 'Customize\\Controller\\SamplePageController::testMethod2',  '_route' => 'redirect_home',);
            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
            if (!in_array($canonicalMethod, ['GET'])) {
                if ($hasRequiredScheme) {
            ...
            if (!$hasRequiredScheme) {
                ...
                return array_replace($ret, $this->redirect($rawPathinfo, 'redirect_home', key($requiredSchemes)));
            }
